Nova.booting((Vue, router, store) => {
    ...
    Vue.component('index-reactive-hidden-field', Vue.component('index-hidden-field'));
    Vue.component('detail-reactive-hidden-field', Vue.component('detail-hidden-field'));
    Vue.component('form-reactive-hidden-field', require('./components/form/ReactiveHiddenField').default);
